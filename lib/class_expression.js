 ...
 * @param {Boolean} inferred_p - (optional) whether or not the type is inferred (default false)
 */
class_expression = function(in_type, inferred_p){
...
/**
 * Get whether or not the class expression is set to be identified as
 * "inferred".
 * 
 * @returns {Boolean} true or false
 */
class_expression.prototype.inferred_p = function(){
 ...
 */
class_expression.prototype.to_string = function(){
    var anchor = this;
    ...
    // BUG/TODO: this will probably disappear in the future when
    // inferred_p goes.
    // A little special "hi" for inferred types.
    if( typeof(anchor.inferred_p) === 'function' && anchor.inferred_p() ){
	ret = '[' + ret + ']';
    }
